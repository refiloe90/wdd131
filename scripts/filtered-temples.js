...
document.getElementById("old").addEventListener("click", showOldTemples);
document.getElementById("new").addEventListener("click", showNewTemples);
document.getElementById("large").addEventListener("click", showLargeTemples);
document.getElementById("small").addEventListener("click", showSmallTemples);
